...
class UserController extends Controller
{
    ...
    public function store(Request $request){
        $request->validate([
            // username harus diisi, berupa string, minimal 3 karakter, dan bernilai unik di tabel m_user kolom uername
    ...
    public function update(Request $request, string $id){
        $request->validate([
            ...
            // dan bernilai unik di table m_user kolom username kecuali untuk user dengan id yang sedang di edit
